...
class AsyaListe extends StatefulWidget {
  @override
  _AsyaListeState createState() => _AsyaListeState();
}

class _AsyaListeState extends State<AsyaListe> {
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              yemekKarti("assets/images/noodle.png", "1,5 saat", "Noodle",
                  "Asya"),
              SizedBox(
                width: 20,
              ),
              yemekKarti("assets/images/kimchi.png", "1 saat", "Kimchi",
                  "Asya"),
              SizedBox(
                width: 20,
              ),
